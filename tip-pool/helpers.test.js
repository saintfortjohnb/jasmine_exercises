describe("Utilities test (with setup and tear-down)", function() {
  ...
  it('should show total tip amount on sumPaymentTotal()', function () {
  ...
  it('should show total bill amount on sumPaymentTotal()', function () {
  ...
  it('should show total tip percent on sumPaymentTotal()', function () {
